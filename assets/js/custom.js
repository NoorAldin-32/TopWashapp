...
POTENZA.datatables = function () {
   if ($('#datatable').exists()) {
       loadScript('assets/'+plugin_path + 'bootstrap-datatables/jquery.dataTables.min.js', function() {
       loadScript('assets/'+plugin_path + 'bootstrap-datatables/dataTables.bootstrap4.min.js', function() {
      $('#datatable').DataTable();
     });
       });
    }
...
POTENZA.Sidebarnav = function () { 
  /*Sidebar Navigation*/
    $(document).on('click', '#button-toggle', function (e) {
      $('.side-menu-bg > ul> li').toggleClass("cc"); 
      $('.side-menu-fixed').toggleClass("ac"); 
...
//  $(document).on('click', '#button-toggles', function (e) {
//       // $('.side-menu-bg > ul> li').toggleClass("cc"); 

//       $('.wrapper').toggleClass('d-flex');
//       $('.big_container').toggleClass('col-md-11');
//       $('.card_filter').toggleClass('col-md-1');
